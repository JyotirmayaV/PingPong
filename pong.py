...
wn.title("Ping Pong Game ")    #giving title 
wn.bgcolor("black")
wn.setup(width=800,height =600)
#wn.tracer(0)  #stops window from updating so as to increase game speed

#paddle a
paddle_a = turtle.Turtle()
paddle_a.speed(0)    #ets speed to max possible speed
...
#paddle_ball
ball = turtle.Turtle()
ball.speed(0)    #ets speed to max possible speed
